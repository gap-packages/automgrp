UnitTest("Order", function()
  ...
  group := AutomGroup([[1,1,()]], false);
  AssertEqual(Order(group.1), 1);

  group := AutomGroup("a=(1,2)(3,4)(5,6), b=(1,c,a,c,a,c), c=(a,d,1,d,a,d), d=(a,b,a,b,1,b)", false);
  for i in [1..2] do
  ...
  group := AutomGroup("a=(1,1)(1,2), b=(a,c), c=(a,d), d=(1,b)", false);
  for i in [1..2] do
    if i = 2 then IsContracting(group); fi;
  ...
  group := AutomGroup("a=(1,b)(1,2), b=(1,a)", false);
  for i in [1..2] do
    if i = 2 then IsContracting(group); fi;
  ...
  group := AutomGroup([[1,1,1,1,()],[1,1,1,1,(1,3)(2,4)],[1,2,4,4,()],[1,1,3,3,()]], ["e", "a", "b", "c"], false);
  AssertEqual(Order(group.1 * group.2 * group.3), infinity);

  group := AutomGroup([[1,1,1,1,()],[1,1,1,1,(1,3)(2,4)],[1,2,4,4,()],[2,1,3,3,()]], ["e", "a", "b", "c"], false);
  AssertEqual(Order(group.1 * group.2), infinity);
end);
