...
InstallOtherMethod(FiniteGroupId, "FiniteGroupId(IsList, IsPosInt)", true,
              [IsList, IsPosInt],
function(G,size)
...
InstallOtherMethod(FiniteGroupId, "FiniteGroupId(IsList, IsInfinity)", true, 
              [IsList, IsInfinity],
function(G,size)
  local gr,len, ElList, GrList,inv,i,j,k,oldgr,v,tmpv,New,IsNewRel,inverse,H,FinG,tmpl,push,ProductEls,act,rels, LongCycle;
...
################################################################################
##
#M FindRelsSubs. . . . . . . . . . . .Finds relations between given elements
##                                     stops after investigating "size" elements
##                                      or when it finds "num_of_rels" relations

InstallOtherMethod(FindRelsSubs, "FindRelsSubs(IsList, IsList, IsAutomGroup, IsPosInt, IsPosInt)", true, 
              [IsList, IsList, IsAutomGroup, IsPosInt, IsPosInt],
...
InstallOtherMethod(FindRelsSubs, "FindRelsSubs(IsList, IsList, IsAutomGroup, IsPosInt, IsInfinity)", true, 
              [IsList, IsList, IsAutomGroup, IsPosInt, IsInfinity],
function(subs_words,names,G,size,num_of_rels)
  local gens, Gi, H, rel, rels, rels0, k, track_s, track_l, AssocW, FindRelsLocal, gens_autom, i, j, subs, subs1, w_list, FindRelsSubsLocal, w_ext, w, automgens, numstates, F, cur_gen;
...
##                                     stops after investigating "size" elements
##
InstallMethod(FindRelsSubs, "FindRelsSubs(IsList, IsList, IsAutomGroup, IsPosInt)",
              [IsList, IsList, IsAutomGroup, IsPosInt],
...
InstallOtherMethod(FindRelsSubsSG, "FindRelsSubsSG(IsList, IsList, IsAutomGroup, IsPosInt, IsPosInt)", true, 
              [IsList, IsList, IsAutomGroup, IsPosInt, IsPosInt],
function(subs_words,names,G,size,num_of_rels)
...
InstallOtherMethod(FindRelsSubsSG, "FindRelsSubsSG(IsList, IsList, IsAutomGroup, IsPosInt, IsInfinity)", true, 
              [IsList, IsList, IsAutomGroup, IsPosInt, IsInfinity],
function(subs_words,names,G,size,num_of_rels)
  local gens, Gi, H, rel, rels, rels0, k, track_s, track_l, AssocW, gens_autom, i, j, subs, subs1, w_list, FindRelsSubsSGLocal, w_ext, w, automgens, numstates, F, cur_gen;
...
InstallMethod(FindRelsSubsSG, "FindRelsSubsSG(IsList, IsList, IsAutomGroup, IsPosInt)",
              [IsList, IsList, IsAutomGroup, IsPosInt],
function(subs_words,names,G,size)
...
##
##
InstallOtherMethod(FindRels, "FindRels(IsAutomGroup, IsInfinity, IsInfinity)", true,
              [IsAutomGroup, IsInfinity, IsInfinity],
function(G,size,num_of_rels)
  local gens, Gi, H, rel, rels, rels0, k, track_s, track_l, AssocW, FindRelsLocal;
...
##
##
InstallMethod(FindRels, "FindRels(IsAutomGroup)",
              [IsAutomGroup],
function(G)
