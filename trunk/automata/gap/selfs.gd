...
################################################################################
##
##  CONVERT_ASSOCW_TO_LIST. . . . . . .Converts elements of AutomGroup into lists
##
...
################################################################################
##
##  ReduceWord . . . . . . . . . . . . . . . . . . . . . . .cuts 1s from the word
##
...
################################################################################
##
##  ProjectWord. . . . . . . . . . . . . . . .computes the projection of the word
...
################################################################################
##
##  WordActionOnFirstLevel . . . . . . . . . . . .computes the permutation of the
...
################################################################################
##
##  WordActionOnVertex . . . . . . . . . . . . . computes the image of the vertex
...
################################################################################
##
##  IsOneWordContr. . . . . . . . . . . . . . . . . checks if the word is trivial
...
################################################################################
##
##  IS_ONE_LIST. . . . . . . . . . . . . . . . . . . .checks if the word is trivial
...
################################################################################
##
##  CHOOSE_AUTOMATON_LIST        chooses appropriate representation for G
##
...
################################################################################
##
##  GeneratorActionOnVertex. . . . . . . . . . . . . . . . Computes the action of
...
DeclareGlobalFunction("AG_NumberOfVertex");
...
DeclareGlobalFunction("AG_VertexNumber");
DeclareGlobalFunction("VertexNumber");


################################################################################
##
##  GeneratorActionOnLevel . . . . . . . . . . . . . . . . Computes the action of
...
################################################################################
##
##  WordActionOnLevel . . . . . . . . . . . . . . . . . . .Computes the action of
...
################################################################################
##
#F  AG_IsWordTransitiveOnLevel. . . . . . . . . .Returns true if element w of G acts
...
#############################################################################
##
##  IsGeneratedByAutomatonOfPolynomialGrowth(<G>)
##
...
#############################################################################
##
##  IsGeneratedByBoundedAutomaton(<G>)
##
...
#############################################################################
##
##  PolynomialDegreeOfGrowthOfAutomaton(<G>)
##
...
################################################################################
##
#F  AG_GeneratorActionOnLevelAsMatrix. . . . . . . . . . . . . Computes the action of
...
################################################################################
##
##  InvestigatePairs . . . . . . . . . . . . . . . . . . . Searches out relations
...
##
##  Use `IsNoncontracting'~("IsNoncontracting") to try to show that <G> is
##  noncontracting.
##
##  \beginexample
...
################################################################################
##
##  InversePerm. . . . . . . . . . . .Gives permutation on the set of generators
...
################################################################################
##
## AutomGroupGrowthFast. . . . .Computes the growth function while the number of
...
################################################################################
##
##  IsOneWordSubs. . . . . . . . . . . . Determines if the word in terms of given
...
################################################################################
##
##  SUSPICIOUS_FOR_NONCONTRACTION   returns `true' if there is a vertex v,
...
################################################################################
##
##  OrdersOfGroupElementsMain . . . . . Enumerates all elements of a self-similar
...
################################################################################
##
##  OrdersOfGroupElements . . . . . . . Enumerates all elements of a self-similar
##             group up to length n and tries to find their orders up to order O
##                  returns true if all the orders are finite and fail otherwise
...
################################################################################
##
##  PeriodicityGuess. . . . . . . . . . Enumerates all elements of a self-similar
##             group up to length n and tries to find their orders up to order O
##                  returns true if all the orders are finite and fail otherwise
...
################################################################################
##
##  FindTransitiveElements . . . . . . Finds all elements of a group G which are
