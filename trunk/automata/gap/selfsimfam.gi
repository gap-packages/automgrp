...
##
InstallMethod(SelfSimFamily, "SelfSimFamily(IsList, IsList, IsBool)",
...
##
InstallMethod(SelfSimFamily, "method for IsList", [IsList],
function(list)
...
##
InstallMethod(SelfSimFamily, "method for IsList, IsBool", [IsList, IsBool],
...
##
InstallMethod(SelfSimFamily, [IsList, IsList],
function(list, names)
  if not AG_IsCorrectRecurList(list, false) then
...
#M  One(<fam>)
##
InstallOtherMethod(One, "One(IsSelfSimFamily)", [IsSelfSimFamily],
function(fam)
...
##
InstallMethod(GroupOfSelfSimFamily, "GroupOfSelfSimFamily(IsSelfSimFamily)",
              [IsSelfSimFamily],
function(fam)
  local g;
...
##
InstallMethod(SemigroupOfSelfSimFamily, "SemigroupOfSelfSimFamily(IsSelfSimFamily)",
              [IsSelfSimFamily],
function(fam)
  local g;
...
##
InstallMethod(UnderlyingFreeMonoid, "UnderlyingFreeMonoid(IsSelfSimFamily)",
              [IsSelfSimFamily],
function(fam)
  local monoid;
...
##
InstallMethod(UnderlyingFreeGroup, "UnderlyingFreeGroup(IsSelfSimFamily)",
              [IsSelfSimFamily],
function(fam)
